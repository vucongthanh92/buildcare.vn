...
//phần nội dung banner và menu
define("MN_HOME","Trang Chủ");
define("MN_PRODUCT","Sản Phẩm");
define("MN_LIENHE","Liên Hệ");
...
define("KIENTHUCCHUYENNGANH","Kiến Thức Chuyên Ngành");
define("DUANTHAMKHAO","Dự Án Tham Khảo");
define("KETNOIVOICHUNGTOI","Kết Nối Với Chúng Tôi");
define("DUAN","Dự Án");
define("PRICE","Giá");
...
define("GIO_HANG","Giỏ Hàng");
define("TENSANPHAM","Tên");
define("HINHANH","Hình");
define("DONGIA","Đơn Giá");
define("SOLUONG","Số Lượng");
define("THANHTIEN","Thành Tiền");
define("XOA","Xóa");
define("CHUACOSANPHAM","Chưa có sản phẩm");
define("THONGTINKHACHHANG","Thông tin khách hàng");
define("HOTEN","Họ Tên");
define("NHAPHOTEN","Nhập họ tên");
define("ADDRESS","Địa Chỉ");
define("NHAPDIACHI","Nhập địa chỉ");
define("DIENTHOAI","Điện Thoại");
define("PHUONGTHUCTHANHTOAN","Thanh toán");

define('GIAOHANGTHUTIEN','Giao hàng thu tiền tận nơi');
define('MUAVATHANHTOANTAICUAHANG','Mua và thanh toán tại cửa hàng');
define('NOTE','Ghi Chú');
define('DATHANG','Đặt Hàng');
define('NHAPSODIENTHOAI','Nhập số điện thoại');
define('NHAPEMAIL','Nhập email');
...
/* --- menu */
define("MN_HOME","Trang chủ");
define("MN_ABOUTUS","Giới thiệu");
define("MN_SERVICE","Dịch vụ");
define("MN_DOITAC","Đối tác");
define("MN_TINTUC","Tin tức");
...
define("ANHDAIDIEN","Đổi ảnh đại diện");
