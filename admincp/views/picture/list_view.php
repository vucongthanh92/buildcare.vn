<h1><img src = '<?php echo ADMIN_PATH_IMG;?>s_db.png'> <?php echo PICTURE_TITLE; ?></h1>
<br/>
<br/>
<img src = '<?php echo ADMIN_PATH_IMG;?>b_insrow.png'><a href = '<?php echo BASE_URL_ADMIN;?>picture/add'><span class = 'them'> <?php echo G_ADD; ?></span></a>
<hr/>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="javascript:confirmSave('<?php echo JSM_DO_YOU_REALLY_WANT_TO_SAVE;?>','<?php echo BASE_URL_ADMIN;?>picture/save')"><img class="icon" src="<?php echo ADMIN_PATH_IMG;?>/b_save.png" alt="Update" title="Cập nhật thứ tự" /></A>
</form>
<hr/>
