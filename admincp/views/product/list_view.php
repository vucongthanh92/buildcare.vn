...
<div class="list_button">
     <a href='<?=BASE_URL_ADMIN?>product/add' class="button"><img src='<?php echo ADMIN_PATH_IMG;?>icon-16-plus.png'> Thêm mới</a>
</div>
...
<form method='post' action="<?=BASE_URL_ADMIN;?>product/list" id="formtim">
...
<table class="view">
	...
	<tr>
        ...
        <td align='center'><input type='text' size='15' name='price2[<?=$item['Id'];?>]' value="<?=bsVndDot($item['sale_price']); ?>" 
        ...
        if($item['home'] == "1")
		{
           echo "<div id='home".$item['Id']."'><a href='javascript:hideshow(\"".TBL_PRODUCT."\",\"home\",\"".$item['Id']."\",\"0\",\"home".$item['Id']
		   ."\",\"".BASE_URL_ADMIN."\");' title='Bỏ khóa'><img src='".ADMIN_PATH_IMG."icon-16-default.png'></a></div>";
        }
		else
		{
           echo "<div id='home".$item['Id']."'><a href='javascript: hideshow(\"".TBL_PRODUCT."\",\"home\",\"".$item['Id']."\",\"1\",\"home".$item['Id']
		   ."\",\"".BASE_URL_ADMIN."\");' title = 'Khóa tin'><img src = '".ADMIN_PATH_IMG."icon-16-nondefault.png'></a></div>"; 
        }
        ?>
        </td>	
        ...
        if($item['new'] == "1")
		{
           echo "<div id='new".$item['Id']."'><a href='javascript: hideshow(\"".TBL_PRODUCT."\",\"new\",\"".$item['Id']."\",\"0\",\"new".$item['Id']
		   ."\",\"".BASE_URL_ADMIN."\");' title = 'Bỏ khóa'><img src = '".ADMIN_PATH_IMG."icon-16-default.png'></a></div>";
        }
		else
		{
            echo "<div id='new".$item['Id']."'><a href='javascript: hideshow(\"".TBL_PRODUCT."\",\"new\",\"".$item['Id']."\",\"1\",\"new".$item['Id']
			."\",\"".BASE_URL_ADMIN."\");' title = 'Khóa tin'><img src = '".ADMIN_PATH_IMG."icon-16-nondefault.png'></a></div>"; 
        }
        ?>
        </td>	
        ...
        <td align='center' width="30"><a href='<?=BASE_URL_ADMIN."product/del/".$item['Id'];?>' title='Xóa' onclick='javascript:thongbao("
