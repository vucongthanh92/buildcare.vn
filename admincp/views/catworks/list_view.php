...
<div class="main_area">
    ...
    <td> Quản lý nội dung / Danh mục dự án </td>
...
<a href = '<?php echo BASE_URL_ADMIN;?>catworks/add' class="button"><span class = 'them'> <?php echo G_ADD; ?></span></a>

</div>



<form action = '<?php echo BASE_URL_ADMIN;?>catworks/del' method = 'post'  name="rowsForm" id="rowsForm">
			...
			?>
				...
				<tr>
					...
					if($item['ticlock'] == "1"){
						...
						echo "<div id = '".$item['Id']."'><a href = 'javascript:ticlockactive(\"".TBL_CATWORKS."\",\"ticlock\",\"".$item['Id']."\",\"0\",\"".BASE_URL_ADMIN."\");' title = 'Bỏ khóa'><img src = '".ADMIN_PATH_IMG."icon-16-remove.png'></a></div>";

					}else{

						echo "<div id = '".$item['Id']."'><a href = 'javascript:ticlockactive(\"".TBL_CATWORKS."\",\"ticlock\",\"".$item['Id']."\",\"1\",\"".BASE_URL_ADMIN."\");' title = 'Khóa tin'><img src = '".ADMIN_PATH_IMG."icon-16-tick.png'></a></div>"; 
					...
					<td align = 'center'><a href = '<?php echo BASE_URL_ADMIN;?>catworks/edit/<?php echo $item['Id'];?>' title = 'Sửa'><img src = '<?php echo ADMIN_PATH_IMG;?>b_edit.png'></a></td>

					<td align = 'center'><a href = '<?php echo BASE_URL_ADMIN."catworks/del/".$item['Id'];?>' title = 'Xóa' onclick = 'javascript:return thongbao("<?php echo JSM_DO_YOU_REALLY_WANT_TO_DELETE;?>");'><img src = '<?php echo ADMIN_PATH_IMG;?>b_drop.png'></a></td>
...
<a href="javascript:confirmSave('<?php echo JSM_DO_YOU_REALLY_WANT_TO_SAVE;?>','<?php echo BASE_URL_ADMIN;?>catworks/save')" class="button">Save</a>
