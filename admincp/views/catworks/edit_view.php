...
<div class="main_area">
    ...
    <td> Quản lý nội dung / Sửa danh mục dự án </td>
...
<form action = '<?php echo BASE_URL_ADMIN;?>catworks/edit/<?php echo $data['info']['Id']?>' method = 'post' enctype = "multipart/form-data">
...
<?php } ?>
    ...
    <tr>
		...
		<td><input type = 'text' name = 'title_en' size = '90' value = '<?php echo $data['info']['title_en'];?>'></td>
