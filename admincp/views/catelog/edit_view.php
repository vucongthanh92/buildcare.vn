...
<td valign="top">
	<table class="right_new" >
        ...
        <tr>
            ...
            <td>
            	<textarea name="meta_keyword" style="width:320px; height:100px;"><?php echo $data['info']['meta_keyword'];?></textarea>
            </td>
        </tr>
         <tr>
            <td class = 'title_td'> Meta Description</td>
            <td>
            	<textarea name="meta_description" style="width:320px; height:100px;"><?php echo $data['info']['meta_description'];?></textarea>
            </td>
        </tr>
    </table>
</td>
