...
<a href = '<?php echo BASE_URL_ADMIN?>works/add' class="button"><img src = '<?php echo ADMIN_PATH_IMG;?>icon-16-plus.png'> Thêm mới</a>
...
<table class="view">
...

	{
		...
		<tr>
			...
			<td><img src = '<?php echo BASE_URL;?>data/Works/<?php echo $item['images']; ?>' width = '60'></td>
            <td align = 'center'>
			...
			<td align = 'center'  width="30"><a href = '<?php echo BASE_URL_ADMIN;?>works/edit/<?php echo $item['Id'];?>' title = 'Sửa'><img src = '<?php echo ADMIN_PATH_IMG;?>b_edit.png'></a></td>

			<td align = 'center'  width="30"><a href = '<?php echo BASE_URL_ADMIN."works/del/".$item['Id'];?>' title = 'Xóa' onclick = 'javascript:thongbao("<?php echo JSM_DO_YOU_REALLY_WANT_TO_DELETE;?>");'><img src = '<?php echo ADMIN_PATH_IMG;?>b_drop.png'></a></td>
...
<a href = '<?php echo BASE_URL_ADMIN;?>works/add' class="button"><span class = 'them'> <img src = '<?php echo ADMIN_PATH_IMG;?>icon-16-plus.png'> <?php echo G_ADD; ?></span></a>
...
<a href="javascript:confirmSave('<?php echo JSM_DO_YOU_REALLY_WANT_TO_SAVE;?>','<?php echo BASE_URL_ADMIN;?>works/save')" class="button" ><img class="icon" src="<?php echo ADMIN_PATH_IMG;?>/b_save.png" alt="Update" title="Cập nhật thứ tự" /> Save</A>
