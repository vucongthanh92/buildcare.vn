...
<div class="content">
<div class="content_i">
<form name="frm1" action='<?=BASE_URL_ADMIN;?>product/edit/<?=$data['info']['Id'];?>' method='post' enctype="multipart/form-data" 
...
<tr>
   ...
   <table>
      ...
      <tr>
         ...
         <td><textarea name="description_<?=$vlang?>" id="description_<?=$vlang?>" style="width:640px;height:100px">
		     <?=stripcslashes($data['info']['description_'.$vlang])?></textarea></td>
      </tr>
   ...
   <table class="right_new" >
      ...
      <tr>
         ...
         <td><input type='text' name='sale_price' value='<?=bsVndDot($data['info']['sale_price']);?>' onkeyup="this.value=FormatNumber(this.value);" 
            size="30"> </td>
      </tr>
      ...
      <tr>
        ...
        <td><input type='text' name='codepro' value='<?=$data['info']['codepro'];?>' size='50'></td>
    </tr>
